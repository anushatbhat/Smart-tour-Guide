    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="form">
                ...
                <form action='uploaddb.php' class="btnn" method="POST" style="text-align:center;"
                    enctype="multipart/form-data">


                    <label for="user">Select a file to upload:</label>
                    <br>
                ...
                <form action='uploadnew.php' class="btnn" method="POST" style="text-align:center;">
